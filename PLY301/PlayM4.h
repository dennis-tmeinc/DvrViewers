...
#define BUF_VIDEO_SRC_REMIANDATA    (7) //mixed input,remain data for video&audio;
                                        //splited input,remain data for video only
#define BUF_VIDEO_DEMUX_REMIANDATA  (8) //mixed input,remain data for video&audio to demux;
                                        //splited input,remain data for video only to demux;
#define BUF_AUDIO_DEMUX_REMIANDATA  (9) //mixed input,not define;
                                        //splited input,remain data for audio to demux;
